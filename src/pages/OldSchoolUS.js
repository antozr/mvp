...
function OldSchoolUS() {
  ...
  let texteTitleCol = ["Un style qui", " se demarque", "Les artistes", "Les hirondelles", " Les Pin-up", "Les ancres & navires"];
    ...
    <div className="oldschool page">
      <section className="sect ">
        ...
        <div className="sect__boxIntro sect--row sect__boxIntro--minHeigt">
          <img src={HeartSVG} alt="Voici une représentation d'un sacré coeur dans le style tradi américain." className="sect__imgDecor sect__imgDecor--min sect__imgDecor--rotateY sect__imgDecor--spaceLeft" />
      ...
      <div className="sect__nameBigBox">
      ...
      <div className="sect--heigth100">
        <SectionMotifHori Img01={Hirondelle} Img02={PinUp01} Img03={Navire} title01={texteTitleCol[3]} title02={texteTitleCol[4]} title03={texteTitleCol[5]} txt01={texteCol[6]} txt02={texteCol[7]} txt03={texteCol[8]} />
