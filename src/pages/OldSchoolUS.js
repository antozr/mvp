...
function OldSchoolUS() {
  ...
  <>On peut situer ces premières apparition en tant que point d’influence dés le début du 20e siècles & principalement aux US ,<span className="sect__txt--thin sect__txt--italic"> comme à Honolulu, San Francisco, New-York mais aussi à Bristol.</span> <br /> <br /> <br /></>,
  <><span  >On peut noter que certains artistes ont permis de faire naître cet effort ainsi que montrer cet art au grand public, pour se faire on retrouve <b>Sailor Jerry</b> qui vas faire évoluer le style en y intégrant des iconographies japonais en plus qu’un retravaille des anciennes iconographies. On lui doit aussi une amélioration des techniques de tatouages notamment avec l’intégration de celle-ci pour en améliorer. Avec son apprenti,<b> Don Ed Hardy</b>, qui va populariser le style au grand public dans les années 70-80, tout en y intégrant une plus grande iconographie japonaise. On peut retrouver certaines collaborations avec des marques de textiles & une marque de rhum pour Sailor Jerry.</span></>,
