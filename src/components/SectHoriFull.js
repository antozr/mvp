...
function SectHoriFull() {
    let texteTitleCol = ["Un style qui", " se demarque", "Sailor Jerry"];
        ...
        <section className="sect sect__artiste hori">
            <div className="hori__rowContainer" ref={boxRef}>
                ...
                <div className="hori__box hori__box--black" id='contentSailor'>
                    ...
                    <ContentBoxHori linkImg01={SailorJerry02} title01={texteTitleCol[2]} title02={""} text01={texteCol[3]} text02={texteCol[4]} text03={""} colorTxt={{ color: '#FDF2DE' }} />
                </div>
                ...
                <div className="hori__box ">
                    <ContentBoxHori linkImg01={DonEdHardy01} title01={'L\'apprenti du '} title02={"marin"} text01={texteCol[5]} text02={""} text03={""} colorTxt={{ color: '#000' }} />
