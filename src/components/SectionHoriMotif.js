        ...
        <section className="sect sect__artiste sect__artiste--rotate  hori"  >
            <div className="hori__rowContainer hori__rowContainer--artiste hori__rowContainer--motif  hori__rowContainer--white" style={columStyle} id='rowMotf' ref={boxRef}>
                <div className="hori__box hori__box--motif " id='Motif01' >
                  {window.innerWidth >= 900 ?<PresentationMotif Img01={Img01} Img02={Img012} title1={title01} txt1={txt01} style2={{ width: '50%', objectFit: 'contain' }} nameIllu={nameIllu1} OneImg={OneImg1} StyleIlluBox={styleBoxIllu1}/>:
                  <PresentationMotif Img01={Img01} Img02={Img012} title1={title01} txt1={txt01} style2={{width:'100%'}} nameIllu={nameIllu1} OneImg={OneImg1} StyleIlluBox={styleBoxIllu1}/>}
                    {/* <PresentationMotif Img01={Img01} Img02={Img012} title1={title01} txt1={txt01} style2={window.innerWidth >= 900 ?{ width: '50%', objectFit: 'contain' }:{width:'100%'}} nameIllu={nameIllu1} OneImg={OneImg1} StyleIlluBox={styleBoxIllu1}/> */}

                </div>
                <div className="hori__box hori__box--motif hori__box--black" id='Motif02'>
                  {window.innerWidth >= 900 ?<PresentationMotif Img01={Img02} Img02={Img021} title1={title02} txt1={txt02} style2={{color:"#FDF2DE", width:"60ch"}} nameIllu={nameIllu2}  StyleIlluBox={styleBoxIllu2}/>:
                  <PresentationMotif Img01={Img02} Img02={Img021} title1={title02} txt1={txt02} style2={{width:'100%'}} nameIllu={nameIllu2}  StyleIlluBox={styleBoxIllu2}/>}
                    {/* <PresentationMotif Img01={Img02} Img02={Img021} title1={title02} txt1={txt02} style2={window.innerWidth >= 900 ?{color:"#FDF2DE", width:"60ch"}:{width:'100%'}} nameIllu={nameIllu2}  StyleIlluBox={styleBoxIllu2}/> */}
                ...
                <div className="hori__box hori__box--changeMap hori__box--black sect__nameBigBox--fondImg " id='Motif04'>
                    <Link to='/#mapWorld' onClick={ChangeStateDataVisited} aria-label="Retour à la home" >
