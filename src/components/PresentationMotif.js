        ...
        <>
            {OneImg === true ? <>
                ...
                <div className="sect__illu sect__illuGrid" style={StyleIlluBox}>
                    ...
                    <BoxImageAnim positionTB={window.innerWidth >= 900 ?{ position: "absolute", bottom: '-22vh', left: "35%", gridColumn :1/2,gridRow: 1 / 2 }:""} urlImg={Img02} className={"imgBoxDiv imgBoxDiv__big  imgBoxDiv__smallImg"} nameImg={nameIllu}/>
                ...
                <div className="sect sect__illu" style={StyleIlluBox}>
                    <BoxImageAnim positionTB={window.innerWidth >= 900 ?{ top: '-25vh', height: 'calc(150vh - 220px)' }:""} urlImg={Img01} className={"imgBoxDiv imgBoxDiv--toTop"}  nameImg={nameIllu}/>
                    <BoxImageAnim positionTB={window.innerWidth >= 900 ?{ margin: '0 25px', bottom: '-10vh', height: 'calc(150vh - 220px)' }:""} urlImg={Img02} className={"imgBoxDiv imgBoxDiv--toBottom"} nameImg={nameIllu}/>
